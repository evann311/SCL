...
_config_vqa_vast = {
    ...
    # PL Trainer Setting
    'resume_from': '/home/user/SCL/result/finetune_vqa_randaug_seed0_from_GLSCL-100k/version_1/checkpoints/epoch=1-step=4660.ckpt', # load interrupted ckpt
    'fast_dev_run': False, # for debug
    'test_only': False,
    ...
    'log_dir': "result",
    'per_gpu_batchsize': 96,  # you should define this manually with per_gpu_batch_size=#
    'num_gpus': 2,
    'num_nodes': 1,
