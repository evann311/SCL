...
_config_vqa_kg = {
    ...
    'batch_size': 76,  # this is a desired batch size; pl trainer will accumulate gradients when per step batch is smaller.
    ...
    'log_dir': "result",
    'per_gpu_batchsize': 38,  # you should define this manually with per_gpu_batch_size=#
    'num_gpus': 2,
    'num_nodes': 1,
